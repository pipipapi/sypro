...
public class HttpClientUtils {
	...
	public static String sendGet(String url, String charSet)
		...
		return sendGet(url, charSet, 4000, 90000);
	}

	public static String sendGet(String url, String charSet, int cTimeout,
			int sTimeout) throws ClientProtocolException, IOException {
		return Request.Get(url).connectTimeout(cTimeout)
				.socketTimeout(sTimeout).execute().returnContent()
...
//		String result = null;
//		try {
//			result = HttpClientUtils.sendGet(url);
//		} catch (IOException e) {
